...
# MongoDB setup
client = MongoClient(
    'mongodb+srv://admin:Crma%40123@tgr.wakk1.mongodb.net/'
)  # Replace with your MongoDB URI if using Atlas or a remote server
...
def insert_data_to_mongo(data):
    ...
    try:
        ...
        )  # Dividing by 10000 to get the first two digits

        # Combine formatted date with the first two digits of milliseconds
        data['timestamp'] = f"{formatted_date}:{milliseconds:02}"
